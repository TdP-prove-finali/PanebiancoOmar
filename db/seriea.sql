...
# Database: seriea
# Generation Time: 2020-06-17 16:12:31 +0000
# ************************************************************
...
CREATE TABLE `statistiche_casa` (
  ...
  `prob_autogol_a_favore` double NOT NULL,
  `prob_autogol_contro` double NOT NULL,
  `falli_fatti` double NOT NULL,
  `falli_subiti` double NOT NULL,
  `prob_espulsione` double NOT NULL,
  PRIMARY KEY (`id_squadra`),
...
INSERT INTO `statistiche_casa` (`id_squadra`, `tiri_totali_fatti`, `tiri_azione_fatti`, `tiri_piazzato_fatti`, `tiri_rigore_fatti`, `gol_azione_realizzati`, `gol_piazzato_realizzati`, `gol_rigore_realizzati`, `tiri_totali_concessi`, `tiri_azione_concessi`, `tiri_piazzato_concessi`, `tiri_rigore_concessi`, `gol_azione_subiti`, `gol_piazzato_subiti`, `gol_rigore_subiti`, `prob_autogol_a_favore`, `prob_autogol_contro`, `falli_fatti`, `falli_subiti`, `prob_espulsione`)
VALUES
	(1,21.8,16.3,5.2,0.3,2.1,0.4,0.3,9.7,6.6,3,0.1,1,0.3,0.1,0,0.17,13.5,12.9,0.01),
	(2,14.2,11.1,2.9,0.2,0.7,0.5,0.2,11.8,8.9,2.5,0.4,0.9,0.4,0.3,0.08,0,15.4,16.2,0.03),
	(3,11.7,7.8,3.9,0,0.5,0.5,0,17.9,13.8,3.7,0.5,1.2,0.2,0.4,0.08,0.15,13.7,16.5,0.02),
	(4,12.9,10.3,2.4,0.2,1.5,0.3,0,13.1,10.5,2.3,0.4,1.1,0.3,0.3,0.08,0.08,14.3,11.9,0),
	(5,16,11.1,4.7,0.2,0.6,0.3,0.2,9.8,7,2.7,0.1,1.1,0.2,0.1,0,0,15.3,14.4,0.02),
	(6,13.7,8.9,4.5,0.3,0.8,0.2,0.3,12.8,9,3.5,0.3,0.8,0.3,0.3,0,0.08,16.5,14.1,0.01),
	(7,19,14.6,4.2,0.2,1.5,0.3,0.2,12.2,8.4,3.7,0.2,0.7,0.1,0.1,0,0,12.8,10.6,0.01),
	(8,20.5,16.2,3.8,0.5,1.6,0.3,0.5,9.5,6,3.5,0,0.5,0.2,0,0.08,0,12.5,11.9,0.01),
	(9,17.7,13.1,3.9,0.7,1.7,0.4,0.6,12.6,8.6,3.8,0.1,0.5,0.1,0.1,0.07,0,11.1,10.4,0),
	(10,14.3,11,2.9,0.4,0.8,0.2,0.4,17.9,13.7,3.8,0.4,1.3,0.3,0.3,0,0.08,13.2,14.4,0.01),
	(11,17.6,14.3,3.3,0,0.6,0.3,0,11.1,7.8,3.1,0.2,0.9,0.2,0.1,0.08,0,14.2,13.6,0.01),
	(12,22,16.8,5.2,0,1,0.3,0,11.6,9.2,2.4,0,1.3,0.2,0,0,0,11.3,12.9,0.01),
	(13,14.9,10.2,4.5,0.2,1.1,0.2,0,14.8,10.6,3.7,0.5,0.6,0.2,0.2,0.08,0,14.6,12.2,0),
	(14,21,14.3,6.4,0.3,1.1,0.5,0.2,10.5,7.6,2.6,0.4,0.8,0.3,0.4,0.23,0,14,12,0.01),
	(15,18.1,13.3,4.4,0.4,0.7,0.1,0.3,10.6,7.8,2.6,0.1,1,0.3,0.1,0,0.14,14.2,12.2,0.01),
	(16,14.8,11.2,3.5,0.1,2,0.1,0,12.6,9.5,2.7,0.4,1,0.2,0.3,0,0.15,13.4,14.5,0),
	(17,15.1,10.9,3.9,0.3,0.5,0.2,0.3,15.3,10.7,4.3,0.3,1.3,0,0.3,0,0.08,14.2,13.9,0.01),
	(18,10.5,7,3.4,0.1,0.8,0.1,0.1,16.6,12.6,3.6,0.4,0.9,0.6,0.3,0,0,16.2,14.8,0.02),
	(19,14.6,11.3,3.3,0,0.7,0.2,0,13,9.3,3.6,0.2,0.7,0.1,0.2,0,0,14.9,12.8,0),
	(20,11,7.6,3.1,0.3,0.6,0.4,0.3,13.1,8.7,4.2,0.3,0.7,0.1,0.3,0.08,0,14.3,14,0.01);
...
VALUES
	(1,18.7,14.2,4.2,0.3,2.1,0.5,0.2,12.6,8.5,3.8,0.3,0.8,0.1,0.2,0.08,0,13.7,15.1,0.01),
	(2,15,11.6,3.2,0.2,1.1,0.1,0.2,14.8,10.1,4.6,0.1,1.3,0.2,0.1,0.23,0.08,15.6,13.8,0),
	(3,9.7,6.3,3.2,0.2,0.3,0.2,0.2,18.6,13.9,4.6,0.1,1.2,0.5,0.1,0,0,12.6,15.2,0.01),
	(4,11.1,8.8,2,0.3,0.9,0.2,0.3,18.5,14.4,3.9,0.2,1.1,0.1,0.2,0.08,0.08,14.9,11.1,0.02),
	(5,12.9,8.7,3.8,0.4,0.8,0.2,0.3,13.8,9.8,3.8,0.3,0.9,0.4,0.2,0.15,0,13.8,12.3,0.01),
	(6,10.6,7.7,2.5,0.4,0.9,0.1,0.3,19.2,13.3,5.6,0.3,1.1,0.6,0.3,0,0.07,15,13.8,0.03),
	(7,13.8,10.1,3.3,0.4,1.2,0.5,0.4,13.5,9.5,3.8,0.2,0.8,0.1,0.1,0,0.08,17.1,11.5,0.01),
	(8,14.5,10.3,4,0.2,0.9,0.3,0.2,14.6,10.8,3.2,0.7,0.6,0.1,0.4,0.08,0,14.5,13.8,0.01),
	(9,13.5,10.7,2.5,0.3,1.4,0.3,0.2,14.5,10,4.4,0.2,0.7,0.3,0.1,0,0.08,13,10.6,0.01),
	(10,12.6,10,2.3,0.3,0.7,0.3,0.2,20.2,15.5,4.4,0.3,1.8,0.3,0.2,0,0,13.5,13.2,0.02),
	(11,14.2,11.1,2.8,0.3,0.5,0.3,0.3,13.2,9.4,3.4,0.4,0.8,0.4,0.2,0,0.08,14.8,12.2,0.02),
	(12,15,11.3,3.5,0.2,1.3,0.2,0.2,12.2,8.6,3.2,0.4,0.8,0.2,0.3,0.08,0.08,12.1,14.7,0.01),
	(13,9.1,6.9,2.2,0,1.1,0.2,0,21.5,16,5.5,0,1.3,0.3,0,0,0,13.7,11.3,0),
	(14,13.6,8.9,4.3,0.4,1.2,0.4,0.3,11.8,9,2.8,0.1,1,0.2,0.1,0.08,0,14.4,11.4,0.02),
	(15,10.8,7.6,2.9,0.3,0.5,0.3,0.3,14.4,10.5,3.7,0.2,1.4,0.4,0.2,0,0.09,15.9,12.2,0.02),
	(16,14.2,10.5,3.6,0.1,0.9,0.1,0.1,15.7,12.7,2.8,0.2,0.8,0.3,0.2,0,0.08,13.4,15.4,0.01),
	(17,11.8,8,3.6,0.2,0.4,0.1,0.1,17.8,13.5,4.2,0.1,1.1,0.4,0.1,0,0.07,15.8,14.7,0),
	(18,11.4,7.4,3.7,0.3,0.6,0.3,0.3,17.6,12.7,4.6,0.3,1.2,0.2,0.2,0.08,0.08,16.7,14,0.01),
	(19,11.6,9.1,2.5,0,0.7,0.2,0,17.8,13.5,3.9,0.4,1.2,0.4,0.4,0,0,12.3,10.1,0.02),
	(20,12.1,8.6,3.3,0.2,0.7,0.1,0.1,19.2,14,5,0.2,0.5,0.3,0.2,0.08,0,16.2,12.8,0.01);
